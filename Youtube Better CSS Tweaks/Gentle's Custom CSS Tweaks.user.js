...
const gmc = new GM_config({
    ...
    fields: {
        ...
        FORCEH264: {
            ...
            type: 'checkbox',
            default: true,
            title: 'Force videos to use the H264 codec.'
        },
        FORCE1080: {
            label: 'Force 1080p',
            type: 'checkbox',
...
/* Misc */
#GentlesCustomCSSTweaks_config .config_var {margin: 6px 5px; display: flex;}
#GentlesCustomCSSTweaks_config input {order: -1; accent-color: #6c409b;}
...
function Wait(selector, callback, once = 0) {return waitForKeyElements(selector, callback, once);}
    ...
    if (gmc.get('FORCEH264')) {
        const DISALLOWED_TYPES_REGEX = /webm|vp8|vp9|avc1|av01|av1/i;
