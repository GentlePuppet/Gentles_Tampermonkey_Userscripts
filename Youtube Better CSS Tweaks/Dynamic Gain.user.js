...
async function boostAudio() {
    ...
    if (!video || video === currentVideo) {return setTimeout(boostAudio, 5000);}
    ...
    async function updateGainFromStats() {
        ...
        // If the previous function fails try it again after 5 seconds
    ...
    window.addEventListener("yt-page-data-updated", () => setTimeout(updateGainFromStats, 1000));
