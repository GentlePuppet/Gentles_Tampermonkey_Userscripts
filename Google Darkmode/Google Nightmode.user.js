...
GM_addStyle(`
    ...
    .NQyKp.h4wEae, .IiOSLb .rsGxI.Ww4FFb, .Ww4FFb, .vIifob, .Lu57id,  .REySof.T9jMmf, .NQyKp.Hyaw8c, .b0Xfjd.Hyaw8c, .zqrO0 .niO4u, .YXe3R, .pD4qTd .yMAEcf, .ZFiwCf, .dvfTSb.OdANFd {background-color: #141414 !important; color: #bbb !important;}
    ...
    a:link, .w, #prs a:visited, #prs a:active, .q:active, .q:visited, .kl:active, .tbotu, .g0F6u, .KwU3F, .xSQxL{ color: #2c67ef !important; }
