...
function CheckForSelfRetweet (jnode) {
    ...
    var Retweeter = jnode.parents('article[role="article"]').find('article > div > div > div > div:nth-child(2) > div:nth-child(2) > div:nth-child(1) > div > div > div:nth-child(1) > div:nth-child(1) > a[role="link"]').attr('href');
