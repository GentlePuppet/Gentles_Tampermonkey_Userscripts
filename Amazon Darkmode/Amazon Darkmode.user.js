...
GM_addStyle(`
    .a-color-base, .checkout-card-color, .ya-card__heading--rich, .displayAddressDiv .displayAddressUL li,
    ...
    .a-unordered-list .a-list-item, ol .a-list-item, .aplus-v2 .apm-sidemodule, .nav-flyout, #productDescription, .a-box, #nav-subnav.spacious, #nav-subnav.spacious .nav-a.nav-active .nav-a-content, .vse-related-videos-container .vse-video-title,
...
// Invert Filter
GM_addStyle(`
    .awl-ul-share-icon, .lists-desktop-rio-icons, .awl-ul-item-grab, .switch-list, .switch-grid,
    .s-result-list-placeholder .a-spinner, img[id="itemDragIcon_IPNG8TIQX8O45"], img[alt="Place Your Order - Amazon.com Checkout"],
    .a-checkbox label, .a-radio label, .a-color-tertiary, .a-price, .g-transparent, img[alt="Select a Shipping Address - Amazon.com Checkout"],
...
GM_addStyle(`
    ...
    #navbar[data-template=layoutSwapToolBar].layout2 #nav-belt {background: #1b1321 !important;}
    ...
    .order-card .delivery-box__secondary-text, .order-card .delivery-box__primary-text,#deliveredAddress-container .lastReached .milestone-primaryMessage, #progressTracker-container .lastReached .milestone-primaryMessage, #deliveredAddress-container .reached .milestone-primaryMessage, #progressTracker-container .reached .milestone-primaryMessage {color: #009cb3 !important;}
`);
